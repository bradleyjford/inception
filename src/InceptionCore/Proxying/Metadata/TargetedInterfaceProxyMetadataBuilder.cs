...
{
    class TargetedInterfaceProxyMetadataBuilder : ProxyMetadataBuilder
    {
        readonly TargetedInterfaceProxyDefinition _proxyDefinition;

        TargetFieldMetadata _targetField;
